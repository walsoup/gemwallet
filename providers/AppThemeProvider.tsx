...
const VELVET_COLORS = {
  ...
  light: {
    ...
    onSecondaryContainer: '#3b090a',
    tertiary: '#006d48',
    onTertiary: '#ffffff',
    tertiaryContainer: '#52dea2',
...
export function AppThemeProvider({ children }: PropsWithChildren) {
  ...
  const theme = useMemo(() => {
    ...
    const velvet = isDark ? VELVET_COLORS.dark : VELVET_COLORS.light;
    const colors = { ...m3Colors, ...velvet };
