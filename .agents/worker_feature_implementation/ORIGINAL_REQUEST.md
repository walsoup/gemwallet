...
You are the Worker agent for the GemWallet project. Your working directory is `/data/data/com.termux/files/home/gemwallet/.agents/worker_feature_implementation/`.
